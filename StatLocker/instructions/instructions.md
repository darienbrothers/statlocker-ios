...
- **US-005**: As a new user, I want onboarding that is short and clear.
...
- **US-010**: As a user, I want the app to feel clean, modern, and motivating.
...
## 5. Screens
- **S-001. Welcome** — Tagline, Get Started, Log In.
- **S-002. Auth** — Sign in with Apple, Google, or Email.
- **S-003. Onboarding (6 steps)** — Team + Level, Position, Club toggle, 3 goals, Tone quiz, Review.
...
## 6. Data
- **D-001. Athlete Profile** — Name, Email, Grad Year, Position, Level, Tone.
- **D-002. Team Info** — HS name, Club name (optional), Level, City, State.
...
- **D-004. Goals** — Type, Target, Progress, Status (On Track / Catch Up / Stretch), AI recommendations.
...
## 8. Build Steps
- **B-001**: **Setup** — Add colors, fonts, logos, and design tokens.
- **B-002**: **Auth** — Build Welcome (S‑001) and Auth (S‑002) with Firebase.
- **B-003**: **Onboarding** — Build Onboarding (S‑003) and save profile (D‑001, D‑002).
